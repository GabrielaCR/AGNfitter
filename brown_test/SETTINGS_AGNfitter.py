...
def CATALOG_settings():
    ...
    ***USER INPUT NEEDED***
    ...
    cat['filename'] = cat['path']+'brown_test/brown2018_syn_rad_BAT_2.txt'   # RXcorrected_2.txt  brown2018_syn_agnfitter-2.txt
   ...
   ##FREQUENCIES/WAVELENGTHS 
    ...
    cat['freq/wl_list'] = np.arange(2,135,3).tolist() #np.arange(5,48,2).tolist()    #126 #138                             
    ...
    cat['freq/wl_unit'] = u.Angstrom #u.micron     ## Astropy unit of freq or wavelength
    ...
    cat['flux_list'] = np.arange(3,136,3).tolist()      #127  #139
                                        ## If ASCII: List of column indexes (int)
    #cat['flux_suffix'] = '_f'          ## If FITS: Common ending of all flux column names (str)    
    cat['fluxerr_list'] = np.arange(4,137,3).tolist() #128  #140
                                        ## If ASCII: List of column indexes (int)
    ...
    cat['output_folder'] =  cat['workingpath'] +'OUTPUT_Brown/' #if no special OUTPUT folder, leave default
...
def FILTERS_settings():
    ...
    filters['XR_14-195'] = [True, 44]  #XR_14-195
    filters['RAD_21E8'] = [True, 43]   #RAD_21E8
    filters['RAD_6E8'] = [True, 42]    #RAD_6E8 
    ...
    ADDfilters=dict()
    ADDfilters['names'] = []#['RAD_6E8','RAD_21E8','XR_16E-1','XR_10']  ## (string/list of strings)User especified filter names. 
                                ## If name has been previously used, an error message will appear. 
    ADDfilters['filenames'] = []#['Rad_0.60e9.txt','Rad_2.14e9.txt', 'XR_1.600.txt','XR_10.246.txt'] ## (string/list of strings) File names of the new filters. 
...
def MODELS_settings():
    ...
    models['STARBURST'] = 'S17_radio' ### Current options:
                                ...
                                ### 'S17' (Schreiber et al. 2017 (submitted))  ### 'S17_newmodel'
                                ### 'S17_newmodel_radio'
                                ### 'S17_radio' 
...
def OUTPUT_settings():
    ...
    out['intlum_models'] = ['sb','bbb', 'bbbdered', 'gal', 'tor','agn_rad', 'sb']  #as first element
    ...
    out['intlum_freqranges'] = np.array([[8.,1000.],[0.1,1.],[0.1,1.],[0.1,1.],[1.,30.],[0.1, 15000.], [1.,30.]])
    out['intlum_names'] = ['LIR(8-1000)','Lbb(0.1-1)', 'Lbbdered(0.1-1)', 'Lga(01-1)', 'Ltor(1-30)','Lagn_rad(0.1-15000)','Lsb(1-30)']

    #SED PLOTTING
    out['realizations2plot'] = 10
    out['plot_residuals']= True
    out['saveSEDresiduals'] = False
